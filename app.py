...
# --- Barcode-Scanner (wird nur bei Aktivierung geladen) ---
st.header("Artikel per Barcode scannen")
if st.toggle("📷 Kamera aktivieren"):
    # Die Kamera wird nur gerendert, wenn der Schalter aktiv ist.
    img_file_buffer = st.camera_input(
        "Richte die Kamera auf einen Barcode",
        key="barcode_camera",
